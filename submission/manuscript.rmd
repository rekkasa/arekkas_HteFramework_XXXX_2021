...
quarters---defined using the prediction model of step 3. 

\> > ADD > >

***Effect estimation may be focused on the difference in outcomes for a randomly
selected person from the risk stratum (average treatment effect) or for a
randomly selected person from the treatment cohort within the risk stratum
receiving the treatment under study (average treatment effect on the
treated).***
